...
////            .setTangent(Math.toRadians(0))
//            .splineToLinearHeading(new Pose2d(new Vector2d(FCV2.GPP_BLUE_ARTIFACT_FAR.x, FCV2.GPP_BLUE_ARTIFACT_FAR.y-FCV2.ARTIFACT_DIST), FCV2.RED_ARTIFACT_ANGLE), Math.toRadians(90))
//            .build();
//
//        Action gpp_return = drive.actionBuilder(new Pose2d(new Vector2d(FCV2.GPP_BLUE_ARTIFACT_FAR.x, FCV2.GPP_BLUE_ARTIFACT_FAR.y-FCV2.ARTIFACT_DIST), FCV2.RED_ARTIFACT_ANGLE))
//            .strafeToLinearHeading(FCV2.RED_FAR_SHOOT, FCV2.RED_FAR_ANGLE)
//            .build();
//
...
//            .strafeToLinearHeading(FCV2.GPP_BLUE_ARTIFACT_FAR, FCV2.RED_ARTIFACT_ANGLE)
//            .build();
//
//        waitForStart();
...
//            .setTangent(Math.toRadians(0))
        ...
        Action gpp = drive.actionBuilder(new Pose2d(FCV2.RED_FAR_SHOOT, FCV2.RED_FAR_ANGLE))
//            .setTangent(Math.toRadians(0))
            .splineToLinearHeading(new Pose2d(new Vector2d(FCV2.GPP_RED_ARTIFACT_FAR.x, FCV2.GPP_RED_ARTIFACT_FAR.y-FCV2.ARTIFACT_DIST), FCV2.RED_ARTIFACT_ANGLE), Math.toRadians(90))
            .build();


        Action gpp_return = drive.actionBuilder(new Pose2d(new Vector2d(FCV2.GPP_RED_ARTIFACT_FAR.x, FCV2.GPP_RED_ARTIFACT_FAR.y-FCV2.ARTIFACT_DIST), FCV2.RED_ARTIFACT_ANGLE))
            .strafeToLinearHeading(FCV2.RED_FAR_SHOOT, FCV2.RED_FAR_ANGLE)
            .build();
...
//
        Action human1_return = drive.actionBuilder(new Pose2d(new Vector2d(FCV2.HP_RED_ARTIFACT.x + 5, FCV2.HP_RED_ARTIFACT.y), Math.PI))
//            .setTangent(Math.toRadians(0))
            .strafeToSplineHeading(FCV2.RED_FAR_SHOOT, FCV2.RED_FAR_ANGLE+Math.toRadians(7))
            .build();
//
        Action human2 = drive.actionBuilder(new Pose2d(FCV2.RED_FAR_SHOOT, FCV2.RED_FAR_ANGLE))
            .turnTo(FCV2.RED_ARTIFACT_ANGLE)
        ...
        Action human2_return = drive.actionBuilder(new Pose2d(FCV2.HP_RED_ARTIFACT, FCV2.RED_ARTIFACT_ANGLE))
            .strafeToLinearHeading(FCV2.RED_FAR_SHOOT, FCV2.RED_FAR_ANGLE+Math.toRadians(5.5))
            .build();
