...
public interface FCV2 {
    ...
    // ======Artifact Length======
    double ARTIFACT_DIST = 35;
    double HP_ARTIFACT_DIST = 62;
    // ======RED ARTIFACTS======
    Vector2d GPP_RED_ARTIFACT_FAR = new Vector2d(-42, -20);
    Vector2d GPP_RED_ARTIFACT_CLOSE = new Vector2d(-32, -27);
    Vector2d PGP_RED_ARTIFACT = new Vector2d(-15, -28);
    Vector2d PPG_RED_ARTIFACT = new Vector2d(8, -20.5);
    ...
    Vector2d RED_CLOSE_SHOOT = new Vector2d(14, -14);
    Vector2d RED_FAR_SHOOT = new Vector2d(-58, -12);


    // ======BLUE ARTIFACTS======
    Vector2d GPP_BLUE_ARTIFACT_FAR = new Vector2d(-26, 20);
    Vector2d GPP_BLUE_ARTIFACT_CLOSE = new Vector2d(-33.5, 27);
    Vector2d PGP_BLUE_ARTIFACT = new Vector2d(-15, 28);
    Vector2d PPG_BLUE_ARTIFACT = new Vector2d(8, 20.5);
    Vector2d HP_BLUE_ARTIFACT = new Vector2d(-60,72);
    Vector2d HP_SIDE_BLUE_ARTIFACT = new Vector2d(-61,50);



    // ====== BLUE Shooting Locations======
    Vector2d BLUE_CLOSE_SHOOT = new Vector2d(14, 14);
    ...
    // ======Gates======
    Vector2d BLUE_GATE = new Vector2d(0, 57);
