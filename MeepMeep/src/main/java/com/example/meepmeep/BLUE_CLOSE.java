...
//
//                            .splineToLinearHeading(new Pose2d(FieldConstants.BLUE_CLOSE_SHOOT, FieldConstants.BLUE_CLOSE_ANGLE), FieldConstants.BLUE_CLOSE_ANGLE)
////            .setReversed(true)
////            .splineToConstantHeading(FieldConstants.BLUE_CLOSE_SHOOT, Math.toRadians(0))
//
//            .build();
        ...
        Action artifact3 = myBot.getDrive().actionBuilder(new Pose2d(FieldConstants.BLUE_CLOSE_SHOOT.x, FieldConstants.BLUE_CLOSE_SHOOT.y, FieldConstants.BLUE_CLOSE_ANGLE))
            ...
            .setTangent(Math.PI)
            .splineToConstantHeading(FieldConstants.GPP_BLUE_ARTIFACT, Math.PI/2)
                            .waitSeconds(.2)
            .lineToY(FieldConstants.GPP_BLUE_ARTIFACT.y+FieldConstants.ARTIFACT_DIST+7)

            .build();

        Action artifact3_return = myBot.getDrive().actionBuilder(new Pose2d(FieldConstants.GPP_BLUE_ARTIFACT.x, FieldConstants.GPP_BLUE_ARTIFACT.y+FieldConstants.ARTIFACT_DIST+7, FieldConstants.BLUE_ARTIFACT_ANGLE))
