...
public class Blue15 {
    ...
    public static void main(String[] args) {
        ...
        Action gate_score = drive.actionBuilder(new Pose2d(FCV2.BLUE_CLOSE_SHOOT.x, FCV2.BLUE_CLOSE_SHOOT.y, FCV2.BLUE_CLOSE_ANGLE))
            .setTangent(Math.toRadians(180))
            .splineToLinearHeading(new Pose2d(FCV2.BLUE_GATE.x - 16, FCV2.BLUE_GATE.y+2, Math.toRadians(65)), Math.toRadians(90))            .build();

        Action gate_return = drive.actionBuilder(new Pose2d(FCV2.BLUE_GATE.x - 16, FCV2.BLUE_GATE.y+2, Math.toRadians(65)))
            .setTangent(Math.toRadians(180))
        ...
        Action gate_score2 = drive.actionBuilder(new Pose2d(FCV2.BLUE_CLOSE_SHOOT.x, FCV2.BLUE_CLOSE_SHOOT.y, FCV2.BLUE_CLOSE_ANGLE))
            .setTangent(Math.toRadians(180))
            .splineToLinearHeading(new Pose2d(FCV2.BLUE_GATE.x - 16, FCV2.BLUE_GATE.y+2, Math.toRadians(65)), Math.toRadians(90))
            .build();

        Action gate_return2 = drive.actionBuilder(new Pose2d(FCV2.BLUE_GATE.x - 16, FCV2.BLUE_GATE.y + 2, Math.toRadians(65)))
            .setTangent(Math.toRadians(180))
            .splineToLinearHeading(new Pose2d(FCV2.BLUE_CLOSE_SHOOT.x, FCV2.BLUE_CLOSE_SHOOT.y, FCV2.BLUE_CLOSE_ANGLE), Math.toRadians(90))
            .build();
