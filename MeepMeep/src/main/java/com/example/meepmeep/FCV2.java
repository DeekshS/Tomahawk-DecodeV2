...
public interface FCV2 {
    ...
    double RED_FAR_ANGLE = Math.toRadians(-28.5);
    ...
    Vector2d GPP_RED_ARTIFACT_CLOSE = new Vector2d(-35, -29);
    Vector2d PGP_RED_ARTIFACT = new Vector2d(-15, -26);
    Vector2d PPG_RED_ARTIFACT = new Vector2d(8, -17);
    ...
    Vector2d GPP_BLUE_ARTIFACT_CLOSE = new Vector2d(-32, 24);
    Vector2d PGP_BLUE_ARTIFACT = new Vector2d(-15, 28);
    Vector2d PPG_BLUE_ARTIFACT = new Vector2d(8, 18);
    Vector2d HP_BLUE_ARTIFACT = new Vector2d(-55,73);
